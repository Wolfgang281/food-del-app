    ...
    <div className="w-full min-h-screen bg-stone-50 flex flex-col items-center pb-16">
      ...
      {!shopData && (
        <div className="flex-1 flex items-center justify-center px-4 py-24">
          <div className="w-full max-w-sm bg-white border border-stone-100 rounded-3xl shadow-sm p-10 flex flex-col items-center text-center">
            <div className="w-20 h-20 rounded-full bg-orange-50 flex items-center justify-center mb-6 ring-8 ring-orange-50/50">
              <FaUtensils className="text-orange-500 w-8 h-8" />
            </div>
            ...
            <button
              className="bg-orange-500 hover:bg-orange-600 active:scale-[0.98] text-white text-sm font-semibold px-7 py-3 rounded-full shadow-md shadow-orange-100 transition-all duration-200 cursor-pointer"
      ...
      {shopData && (
        <div className="w-full max-w-3xl flex flex-col gap-6 px-4 sm:px-6 pt-8">
          ...
          {/* Shop card */}
          <div className="w-full bg-white border border-stone-100 rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 relative">
            <button
          ...
          {shopData.items.length === 0 && (
            <div className="w-full bg-white border border-stone-100 rounded-3xl p-10 flex flex-col items-center text-center shadow-sm">
              <div className="w-16 h-16 rounded-full bg-orange-50 flex items-center justify-center mb-5 ring-8 ring-orange-50/50">
            ...
            <div className="w-full flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <h2 className="text-base font-bold text-stone-800">
                  Menu Items
                  <span className="ml-2 text-xs font-semibold text-orange-400 bg-orange-50 px-2 py-0.5 rounded-full">
                    {shopData.items.length}
                  </span>
                </h2>
                <button
                  className="text-xs font-semibold text-orange-500 hover:text-orange-600 uppercase tracking-widest transition-colors cursor-pointer"
                  onClick={() => navigate("/add-item")}
                >
                  + Add Item
                </button>
